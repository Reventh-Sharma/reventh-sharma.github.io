...
*Advised by: Prof. Krishna Etika*
- <u>Project</u>: Optimization of Solar Energy Absorption by NanoFluids using Genetic Algorithm
  - Computational model based on genetic algorithm to determine the optimal nanofluid concentration and flow rate that maximizes energy absorption at a given solar incidence
